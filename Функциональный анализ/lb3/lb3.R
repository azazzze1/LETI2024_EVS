...
fx <- function(x) {ifelse((x >= 0 & x < 9/20), ((100/27) * x^2), ifelse((x > 9/20 & x < 7/10), (9/8), ifelse((x >= 7/10 + 0.000000001 & x <= 1), ( 2 - (7/6) * (1-x)), NA)))}
f = Vectorize(fx)
g = Vectorize(gx)
plot(f, 0, 1, col="red", xlim = c(0,1), ylim = c(0,6.5))
